...
namespace gost89
{
    ...
    */
    ...
    //  C++ Addons --------------------------------------------------------------------------------------
    void Cipher(const FunctionCallbackInfo<Value> &args)
    {
        ...
        uint8_t key256b[32] = "this_is_a_pasw_for_GOST_89";
    ...
    void Decipher(const FunctionCallbackInfo<Value> &args)
    {
        Isolate *isolate = args.GetIsolate();
    ...
    void Initialize(Local<Object> exports)
    {
        ...
        NODE_SET_METHOD(exports, "decipher", Decipher);
    }
